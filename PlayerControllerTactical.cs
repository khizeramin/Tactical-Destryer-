...
public class PlayerControllerTactical : MonoBehaviour
{
    public float speed;
    public float tilt;
    ...
    public GameObject tacticalShots;
    ...
    public void WeaponSwitch()
    {
        ...
        if (Input.GetButton("Fire1") && Time.time > nextFire)
        {
            for (int shotspawn = 0; shotspawn < shotSpawn.Length; shotspawn++)
            {
                ...
                Instantiate(tacticalShots, shotSpawn[shotspawn].position, shotSpawn[shotspawn].rotation);
            }
